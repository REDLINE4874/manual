...
window.CARD_DATA.platinum = {
  ...
  benefits: [
    ...
    "<strong><strong>Plan de suguros</strong></strong>: Rembolso de gastos médicos por accidente, Enfermedad repentina en viajes, Seguro de autos rentados,Liberación de saldo por fallecimiento del titular.",
  ],
};
